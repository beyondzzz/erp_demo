...
urlpatterns = [
    ...
    url(r'^api/basic/department/insert$', department.departmentInsert),
    url(r'^api/basic/department/delete$', department.departmentDelete),
    url(r'^api/basic/department/update$', department.departmentUpdate),
    url(r'^api/basic/department/select$', department.departmentSelect),
